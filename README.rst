...
This is a git repository of the source files for the book Researches on curves of the second order&#13;Also on cones and spherical conics treated analytically, in which the tangencies of Apollonius are investigated, and general geometrical constructions deduced from analysis; also several of the geometrical conclusions of M. Chasles are analytically resolved, together with many properties entirely original by Hearn, George Whitehead. This book is in the Public Domain, see the LICENSE file for details.
